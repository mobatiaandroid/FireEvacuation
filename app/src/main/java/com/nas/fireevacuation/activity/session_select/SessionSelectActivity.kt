        ...
        if (CommonMethods.isInternetAvailable(context)) {
            ...
            call2.enqueue(object : Callback<SubjectsModel> {
                override fun onResponse(
                    call: Call<SubjectsModel>,
                    response: Response<SubjectsModel>
                ) {
...
//                        Log.e("subjects", subjectArrayList.toString())
            ...
            subjectSelect.setOnClickListener {
                ...
                builder.setPositiveButton("OK") { dialog, which ->
                    if (checkedItem == -1){
                        CommonMethods.showLoginErrorPopUp(context, "Please Select")
                    }
                    else{
...
//                Log.e("ClassIDSEssionSelecet", yearGroupsArrayList[checkedItem].id)
            ...
            checkInButton.setOnClickListener {
                if (selectedSession.text.equals("")) {
                    CommonMethods.showLoginErrorPopUp(context, "Please Select Session")
                } else if (selectedSubject.text.equals("")) {
                    CommonMethods.showLoginErrorPopUp(context, "Please Select Subject")
                } else {
                ...
                editText.addTextChangedListener(object : TextWatcher {
                    override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                        ...
                        if (checkInButton.isEnabled) {
                            checkInButton.setBackgroundResource(R.drawable.rounded_green_rectangle)
                        } else {
                            checkInButton.setBackgroundResource(R.drawable.rounded_green_rectangle_disabled)
                        }
                    }
