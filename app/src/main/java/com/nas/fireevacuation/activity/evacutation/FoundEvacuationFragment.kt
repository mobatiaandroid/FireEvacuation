...
class FoundEvacuationFragment : Fragment() {
...
//    lateinit var studentList: ArrayList<Lists>
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_found_evacuation, container, false)
                        ...
                        for (snapshot in snapshot.children){
                            if (snapshot.child("class_id").value  != null) {
                                ...
                                if ((snapshot.child("class_id").value)!!.equals(PreferenceManager.getClassID(context))){
                                    if (snapshot.child("found").value!!.equals("1")) {
